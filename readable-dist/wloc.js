...
class t {
  ...
  static timeLog = (e = "default") => {
    const a = t.#a.get(e);
    a
      ? t.log(`${e}: ${Date.now() - a}ms`)
      : t.warn(`Timer "${e}" doesn’t exist`);
  };
  static warn(...e) {
    t.#r < 2 || ((e = e.map((e) => ` ${e}`)), t.log(...e));
  }
}
class a {
  static escape(e) {
        ...
        for (const t of Object.keys(r)) {
          ...
          switch (!0) {
            ...
            case n instanceof Map && i instanceof Map:
              if (n.size > 0) for (const [e, t] of n) i.set(e, t);
              break;
            case n instanceof Set && i instanceof Set:
              if (n.size > 0) for (const e of n) i.add(e);
              break;
  ...
  static unset(e = {}, t = "") {
    Array.isArray(t) || (t = a.toPath(t));
    return t.reduce(
      (e, a, r) => (r === t.length - 1 ? (delete e[a], !0) : Object(e)[a]),
      e,
    );
  }
}
class r {
  static parse(e) {
    ...
    switch (typeof e) {
      case "string": {
        ...
        Object.keys(i).forEach((e) => a.set(t, e, i[e]));
        break;
      }
      case "object":
        switch (e) {
  ...
  static stringify(e = {}) {
    ...
    const t = [];
    return (
      Object.keys(e).forEach((a) => r.#o(e, a, t)),
      0 === t.length
        ? ""
  ...
  static #o(e, t, n) {
    ...
    void 0 !== i &&
      (null !== i
        ? Array.isArray(i)
          ? i.forEach((a, i) => {
              void 0 !== a && r.#o(e, `${t}[${i}]`, n);
            })
          : r.#n(i)
            ? Object.keys(i).forEach((a) => r.#o(e, `${t}.${a}`, n))
            : n.push([t, String(i)])
        : n.push([t, ""]));
  }
  static #l(e) {
...
class o {
  ...
  static setItem(t = new String(), r = new String()) {
    let n = !1;
    if ("object" == typeof r) r = JSON.stringify(r);
    else r = String(r);
    switch (t.startsWith("@")) {
      case !0: {
  ...
  static #d = (t) => {
    if ("Node.js" !== e) return {};
    {
      ...
      const e = this.path.resolve(t),
        a = this.path.resolve(process.cwd(), t),
        r = this.fs.existsSync(e),
        n = !r && this.fs.existsSync(a);
      if (!r && !n) return {};
      {
        const t = r ? e : a;
        try {
...
var d = (e, t, a, r) => {
    const n = c,
      i = r + a;
    e ^= -1;
    for (let a = r; a < i; a++) e = (e >>> 8) ^ n[255 & (e ^ t[a])];
    return -1 ^ e;
  },
  f = {
    2: "need dictionary",
...
var w = function (e) {
    ...
    for (; t.length; ) {
      ...
      if (a) {
        ...
        for (const t in a) h(a, t) && (e[t] = a[t]);
      }
    }
    return e;
  },
  g = (e) => {
    let t = 0;
    for (let a = 0, r = e.length; a < r; a++) t += e[a].length;
    const a = new Uint8Array(t);
    for (let t = 0, r = 0, n = e.length; t < n; t++) {
      let n = e[t];
...
var y = (e) => {
  ...
  m = (e, t) => {
    ...
    return ((e, t) => {
      ...
      let a = "";
      for (let r = 0; r < t; r++) a += String.fromCharCode(e[r]);
      return a;
    })(i, n);
  },
  k = (e, t) => {
    ...
    return a < 0 || 0 === a ? t : a + b[e[a]] > t ? a : t;
  };
var v = function () {
  ((this.input = null),
    (this.next_in = 0),
...
const _ = 16209;
var x = function (e, t) {
  let a, r, n, i, o, s, l, c, d, f, u, h, w, g, p, b, y, m, k, v, x, E, A, $;
  const S = e.state;
  ((a = e.next_in),
    (A = e.input),
    (r = a + (e.avail_in - 5)),
    ...
    (b = (1 << S.distbits) - 1));
  e: do {
    (h < 15 && ((u += A[a++] << h), (h += 8), (u += A[a++] << h), (h += 8)),
      (y = w[u & p]));
    t: for (;;) {
      if (
        ((m = y >>> 24), (u >>>= m), (h -= m), (m = (y >>> 16) & 255), 0 === m)
      )
        $[n++] = 65535 & y;
      else {
        if (!(16 & m)) {
          if (64 & m) {
            ...
            ((e.msg = "invalid literal/length code"), (S.mode = _));
            break e;
          }
          y = w[(65535 & y) + (u & ((1 << m) - 1))];
          continue t;
        ...
        for (
          ...
          if (
            ...
            if (
              ...
              ((e.msg = "invalid distance too far back"), (S.mode = _));
              break e;
            }
            if (((u >>>= m), (h -= m), (m = n - i), v > m)) {
              if (((m = v - m), m > c && S.sane)) {
                ((e.msg = "invalid distance too far back"), (S.mode = _));
                break e;
              }
          ...
          if (64 & m) {
            ((e.msg = "invalid distance code"), (S.mode = _));
            break e;
          }
          y = g[(65535 & y) + (u & ((1 << m) - 1))];
        }
...
var T = (e, t, a, r, n, i, o, s) => {
  ...
  let L,
    ...
    C = null;
  for (g = 0; g <= E; g++) N[g] = 0;
  for (p = 0; p < r; p++) N[t[a + p]]++;
  for (m = l, y = E; y >= 1 && 0 === N[y]; y--);
  if ((m > y && (m = y), 0 === y))
    return ((n[i++] = 20971520), (n[i++] = 20971520), (s.bits = 1), 0);
  for (b = 1; b < y && 0 === N[b]; b++);
  for (m < b && (m = b), _ = 1, g = 1; g <= E; g++)
    if (((_ <<= 1), (_ -= N[g]), _ < 0)) return -1;
  if (_ > 0 && (0 === e || 1 !== y)) return -1;
  for (j[1] = 0, g = 1; g < E; g++) j[g + 1] = j[g] + N[g];
  for (p = 0; p < r; p++) 0 !== t[a + p] && (o[j[t[a + p]]++] = p);
  if (
    (0 === e
      ? ((O = C = o), (w = 20))
      : 1 === e
  ...
  for (;;) {
    ((L = g - v),
      ...
      (b = d));
    do {
      ((d -= c), (n[h + (T >> v) + d] = (L << 24) | (B << 16) | F));
    } while (0 !== d);
    for (c = 1 << (g - 1); T & c; ) c >>= 1;
    if ((0 !== c ? ((T &= c - 1), (T += c)) : (T = 0), p++, 0 === --N[g])) {
      if (g === y) break;
      g = t[a + o[p]];
    }
    if (g > m && (T & u) !== f) {
      for (
        0 === v && (v = m), h += b, k = g - v, _ = 1 << k;
        k + v < y && ((_ -= N[k + v]), !(_ <= 0));
      ...
      if (((x += 1 << k), (1 === e && x > 852) || (2 === e && x > 592)))
        return 1;
      ((f = T & u), (n[f] = (m << 24) | (k << 16) | (h - i)));
    }
  }
  return (
    0 !== T && (n[h + T] = ((g - v) << 24) | (64 << 16)),
    (s.bits = m),
    0
  );
};
...
const G = (e) => {
  ...
  ae = (e, t) => {
    if (!e) return C;
    const a = new J();
    ((e.state = a), (a.strm = e), (a.window = null), (a.mode = Z));
    const r = te(e, t);
  ...
  se = (e, t, a, r) => {
    ...
    return (
      ...
      r >= i.wsize
        ...
        : ((n = i.wsize - i.wnext),
          n > r && (n = r),
          i.window.set(t.subarray(a - r, a - r + n), i.wnext),
          (r -= n)
            ? (i.window.set(t.subarray(a - r, a), 0),
              (i.wnext = r),
              (i.whave = i.wsize))
            : ((i.wnext += n),
...
var le = {
  ...
  inflate: (e, t) => {
      ...
      switch (a.mode) {
        case Z:
          ...
          if (
            ...
            ((e.msg = "incorrect header check"), (a.mode = Q));
            break;
          }
          if ((15 & f) !== D) {
            ((e.msg = "unknown compression method"), (a.mode = Q));
            break;
          }
          if (
            ((f >>>= 4),
            ...
            ((e.msg = "invalid window size"), (a.mode = Q));
            break;
          }
          ((a.dmax = 1 << a.wbits),
            (a.flags = 0),
            (e.adler = a.check = 1),
            (a.mode = 512 & f ? 16189 : z),
            (f = 0),
            (u = 0));
          break;
        case 16181:
          ...
          if (((a.flags = f), (255 & a.flags) !== D)) {
            ((e.msg = "unknown compression method"), (a.mode = Q));
            break;
          }
          if (57344 & a.flags) {
            ((e.msg = "unknown header flags set"), (a.mode = Q));
            break;
          }
        ...
        case 16185:
          if (
            ...
            g &&
              (a.head &&
                ((A = a.head.extra_len - a.length),
                a.head.extra ||
                  (a.head.extra = new Uint8Array(a.head.extra_len)),
                a.head.extra.set(r.subarray(i, i + g), A)),
              512 & a.flags && 4 & a.wrap && (a.check = d(a.check, r, g, i)),
              (s -= g),
              (i += g),
              (a.length -= g)),
            a.length)
            ...
            do {
              ((A = r[i + g++]),
                a.head &&
                  A &&
                  a.length < 65536 &&
                  (a.head.name += String.fromCharCode(A)));
            } while (A && g < s);
            if (
              (512 & a.flags && 4 & a.wrap && (a.check = d(a.check, r, g, i)),
              (s -= g),
            ...
            do {
              ((A = r[i + g++]),
                a.head &&
                  A &&
                  a.length < 65536 &&
                  (a.head.comment += String.fromCharCode(A)));
            } while (A && g < s);
            if (
              (512 & a.flags && 4 & a.wrap && (a.check = d(a.check, r, g, i)),
              (s -= g),
        ...
        case 16188:
          if (512 & a.flags) {
            ...
            if (4 & a.wrap && f !== (65535 & a.check)) {
              ((e.msg = "header crc mismatch"), (a.mode = Q));
              break;
            }
            ((f = 0), (u = 0));
          }
        ...
        case 16189:
          ...
          ((e.adler = a.check = V(f)), (f = 0), (u = 0), (a.mode = P));
        case P:
          if (0 === a.havedict)
            return (
              (e.next_out = o),
          ...
          ((e.adler = a.check = 1), (a.mode = z));
        case z:
          if (t === N || t === j) break e;
        case q:
          if (a.last) {
            ((f >>>= 7 & u), (u -= 7 & u), (a.mode = X));
            break;
          }
          for (; u < 3; ) {
            if (0 === s) break e;
          ...
          switch (((a.last = 1 & f), (f >>>= 1), (u -= 1), 3 & f)) {
            case 0:
              a.mode = 16193;
              break;
            case 1:
              if ((oe(a), (a.mode = W), t === j)) {
                ((f >>>= 2), (u -= 2));
                break e;
              }
              break;
            case 2:
              ...
              break;
            case 3:
              ((e.msg = "invalid block type"), (a.mode = Q));
          }
          ((f >>>= 2), (u -= 2));
          break;
        case 16193:
          for (f >>>= 7 & u, u -= 7 & u; u < 32; ) {
            if (0 === s) break e;
            (s--, (f += r[i++] << u), (u += 8));
          }
          if ((65535 & f) != ((f >>> 16) ^ 65535)) {
            ((e.msg = "invalid stored block lengths"), (a.mode = Q));
            break;
          }
          if (((a.length = 65535 & f), (f = 0), (u = 0), (a.mode = H), t === j))
            break e;
        case H:
          a.mode = 16195;
        case 16195:
        ...
        case 16196:
          ...
          if (
            ...
            ((e.msg = "too many length or distance symbols"), (a.mode = Q));
            break;
          }
        ...
        case 16197:
          for (; a.have < a.ncode; ) {
            ...
            ((a.lens[ee[a.have++]] = 7 & f), (f >>>= 3), (u -= 3));
          }
          for (; a.have < 19; ) a.lens[ee[a.have++]] = 0;
          if (
            ((a.lencode = a.lendyn),
            (a.lenbits = 7),
            (J = { bits: a.lenbits }),
            ($ = T(0, a.lens, 0, 19, a.lencode, 0, a.work, J)),
            (a.lenbits = J.bits),
            $)
          ) {
            ((e.msg = "invalid code lengths set"), (a.mode = Q));
            break;
          }
        ...
        case 16198:
          for (; a.have < a.nlen + a.ndist; ) {
            ...
            if (k < 16) ((f >>>= y), (u -= y), (a.lens[a.have++] = k));
            else {
              if (16 === k) {
                for (Y = y + 2; u < Y; ) {
                  if (0 === s) break e;
                ...
                if (((f >>>= y), (u -= y), 0 === a.have)) {
                  ((e.msg = "invalid bit length repeat"), (a.mode = Q));
                  break;
                }
                ((A = a.lens[a.have - 1]),
                  (g = 3 + (3 & f)),
              ...
              for (; g--; ) a.lens[a.have++] = A;
            }
          }
          if (a.mode === Q) break;
          if (0 === a.lens[256]) {
            ((e.msg = "invalid code -- missing end-of-block"), (a.mode = Q));
            break;
          }
          if (
            ((a.lenbits = 9),
            (J = { bits: a.lenbits }),
            ($ = T(1, a.lens, 0, a.nlen, a.lencode, 0, a.work, J)),
            (a.lenbits = J.bits),
            $)
          ) {
            ((e.msg = "invalid literal/lengths set"), (a.mode = Q));
            break;
          }
          if (
            ((a.distbits = 6),
            ...
            (J = { bits: a.distbits }),
            ($ = T(2, a.lens, a.nlen, a.ndist, a.distcode, 0, a.work, J)),
            (a.distbits = J.bits),
            $)
          ) {
            ((e.msg = "invalid distances set"), (a.mode = Q));
            break;
          }
          if (((a.mode = W), t === j)) break e;
        case W:
          a.mode = K;
        case K:
          if (s >= 6 && c >= 258) {
          ...
          if (((f >>>= y), (u -= y), (a.back += y), (a.length = k), 0 === m)) {
            a.mode = 16205;
            break;
          }
          if (32 & m) {
          ...
          if (64 & m) {
            ((e.msg = "invalid literal/length code"), (a.mode = Q));
            break;
          }
        ...
        case 16202:
          ...
          if (((f >>>= y), (u -= y), (a.back += y), 64 & m)) {
            ((e.msg = "invalid distance code"), (a.mode = Q));
            break;
          }
          ((a.offset = k), (a.extra = 15 & m), (a.mode = 16203));
        case 16203:
          if (a.extra) {
            for (Y = a.extra; u < Y; ) {
              if (0 === s) break e;
          ...
          if (a.offset > a.dmax) {
            ((e.msg = "invalid distance too far back"), (a.mode = Q));
            break;
          }
          a.mode = 16204;
        case 16204:
          ...
          if (((g = w - c), a.offset > g)) {
            ...
            (g > a.wnext
              ? ((g -= a.wnext), (p = a.wsize - g))
              : (p = a.wnext - g),
              g > a.length && (g = a.length),
              (b = a.window));
          } else ((b = n), (p = o - a.offset), (g = a.length));
          (g > c && (g = c), (c -= g), (a.length -= g));
          do {
            n[o++] = b[p++];
          } while (--g);
          0 === a.length && (a.mode = K);
          ...
          if (a.wrap) {
            ...
            if (
              ...
              4 & a.wrap &&
                w &&
                (e.adler = a.check =
                  a.flags ? d(a.check, n, w, o - w) : l(a.check, n, w, o - w)),
              (w = c),
              4 & a.wrap && (a.flags ? f : V(f)) !== a.check)
            ) {
              ((e.msg = "incorrect data check"), (a.mode = Q));
              break;
            }
            ((f = 0), (u = 0));
          }
        ...
        case 16207:
          if (a.wrap && a.flags) {
            ...
            if (4 & a.wrap && f !== (4294967295 & a.total)) {
              ((e.msg = "incorrect length check"), (a.mode = Q));
              break;
            }
            ((f = 0), (u = 0));
          }
    ...
    return (
      ...
      (a.bits = u),
      (a.wsize ||
        (w !== e.avail_out && a.mode < Q && (a.mode < X || t !== O))) &&
        se(e, e.output, e.next_out, w - e.avail_out),
      (h -= e.avail_in),
      (w -= e.avail_out),
      (e.total_in += h),
      (e.total_out += w),
      ...
      4 & a.wrap &&
        ...
        (e.adler = a.check =
          a.flags
            ? d(a.check, n, w, e.next_out - w)
            : l(a.check, n, w, e.next_out - w)),
      (e.data_type =
        a.bits +
        (a.last ? 64 : 0) +
        (a.mode === z ? 128 : 0) +
        (a.mode === W || a.mode === H ? 256 : 0)),
      ((0 === h && 0 === w) || t === O) && $ === L && ($ = M),
      $
    );
  },
  ...
  inflateGetHeader: (e, t) => {
    if (G(e)) return C;
    const a = e.state;
    return 2 & a.wrap ? ((a.head = t), (t.done = !1), L) : C;
  },
  inflateSetDictionary: (e, t) => {
    ...
    return G(e)
      ...
      : ((r = e.state),
        0 !== r.wrap && r.mode !== P
          ? C
          : r.mode === P && ((n = 1), (n = l(n, t, a, 0)), n !== r.check)
            ? U
            : ((i = se(e, t, a, a)),
              i ? ((r.mode = 16210), I) : ((r.havedict = 1), L)));
  },
...
function ve(e) {
  ...
  let a = le.inflateInit2(this.strm, t.windowBits);
  if (a !== he) throw new Error(f[a]);
  if (
    ((this.header = new ce()),
    ...
    t.dictionary &&
      ...
      t.raw &&
        ((a = le.inflateSetDictionary(this.strm, t.dictionary)), a !== he)))
  )
    throw new Error(f[a]);
}
  ...
  for (
    ...
    for (
      0 === a.avail_out &&
        ...
        i === ge &&
          n &&
          ((i = le.inflateSetDictionary(a, n)),
          i === he ? (i = le.inflate(a, o)) : i === be && (i = ge));
      a.avail_in > 0 &&
      i === we &&
      2 & a.state.wrap &&
      0 !== a.state.flags &&
      ...
      (le.inflateReset(a), (i = le.inflate(a, o)));
    switch (i) {
      case pe:
      case be:
      case ge:
    ...
    if (
      ((s = a.avail_out),
      a.next_out && (0 === a.avail_out || i === we || o > 0))
    )
      if ("string" === this.options.to) {
        let e = k(a.output, a.next_out),
          t = a.next_out - e,
          n = m(a.output, e);
        ((a.next_out = t),
          (a.avail_out = r - t),
...
var _e = {
  ungzip: function (e, t) {
    const a = new ve(t);
    if ((a.push(e, !0), a.err)) throw a.msg || f[a.err];
    return a.result;
  },
};
const { ungzip: xe } = _e;
...
function Ae(e, t) {
  ...
  for (; t < e.length; ) {
    const i = 255 & e[t++];
    if ((n < 56 && (a += (127 & i) * r), !(128 & i))) return [a, t];
    if (((r *= 128), (n += 7), n >= 70))
...
function $e(e) {
  ...
  let r = -t;
  for (let e = 0; e < 8; e++) ((a[e] = 255 & r), (r = Math.floor(r / 256)));
  let n = 1;
  for (let e = 0; e < 8; e++) {
    const t = (255 & ~a[e]) + n;
    ((a[e] = 255 & t), (n = t >> 8));
...
function Se(e) {
  ...
  for (let a = 0; a < e.length; a++)
    for (let r = 0; r < e[a].length; r++) t.push(255 & e[a][r]);
  return t;
}
function Re(e) {
  const t = [];
  ...
  for (; a < e.length; ) {
    ...
    const o = Math.floor(n / 8),
      s = 7 & n;
    if (0 === o) throw new Error("invalid protobuf field 0 at " + r);
    let l;
    if (0 === s) {
      const [t, r] = Ae(e, a);
      ((l = t), (a = r));
    } else if (1 === s) ((l = e.slice(a, a + 8)), (a += 8));
    else if (2 === s) {
      const [t, r] = Ae(e, a);
      ((a = r), (l = e.slice(a, a + t)), (a += t));
    } else {
      if (5 !== s) throw new Error("unsupported wire type " + s);
      ((l = e.slice(a, a + 4)), (a += 4));
    }
    t.push({ fieldNo: o, wireType: s, value: l, raw: e.slice(r, a) });
  }
  return t;
}
function Te(e, t, a) {
  const r = $e(8 * e + t);
  if (0 === t) return Se([r, $e(a)]);
  if (1 === t || 5 === t) return Se([r, a]);
  if (2 === t) return Se([r, $e(a.length), a]);
...
function Oe(e, t, a) {
  ...
  for (const e of r)
    0 === e.wireType && null != s[e.fieldNo]
      ? (o.push(Te(e.fieldNo, 0, s[e.fieldNo])), l.add(e.fieldNo))
      : o.push(e.raw);
  for (const e of [5, 6, 11, 12])
    null != s[e] && !l.has(e) && o.push(Te(e, 0, s[e]));
  return (a.locations++, Se(o));
}
function Ne(e, t, a) {
  const r = Re(e);
  let n = !1;
  for (const e of r)
    if (1 === e.fieldNo && 2 === e.wireType) {
      const t = Array.from(e.value)
        ...
        .join("");
      n = /^[0-9a-fA-F]{1,2}(:[0-9a-fA-F]{1,2}){5}$/.test(t);
    }
  if (!n) return e;
  let i = !1;
  const o = [];
  for (const e of r)
    if (2 === e.fieldNo && 2 === e.wireType)
      try {
        const r = Oe(e.value, t, a);
        ((r.length === e.value.length && r.join(",") === e.value.join(",")) ||
          (i = !0),
          o.push(Te(e.fieldNo, e.wireType, r)));
      } catch {
        (a.skipped++, o.push(e.raw));
      }
    else o.push(e.raw);
  return (i && a.wifi++, Se(o));
}
function je(e, t, a) {
  const r = Re(e);
  let n = !1;
  ...
  for (const e of r)
    if (5 === e.fieldNo && 2 === e.wireType)
      try {
        ...
        ((r.length === e.value.length && r.join(",") === e.value.join(",")) ||
          (n = !0),
          i.push(Te(e.fieldNo, e.wireType, r)));
      } catch {
        (a.skipped++, i.push(e.raw));
      }
    else i.push(e.raw);
  return (n && a.cell++, Se(i));
}
function Le(e, t, a) {
  const r = Re(e),
    n = [];
  for (const e of r)
    2 === e.wireType && 2 === e.fieldNo
      ? n.push(Te(e.fieldNo, e.wireType, Ne(e.value, t, a)))
      : 2 !== e.wireType || (22 !== e.fieldNo && 24 !== e.fieldNo)
        ? n.push(e.raw)
        : n.push(Te(e.fieldNo, e.wireType, je(e.value, t, a)));
  return Se(n);
}
function Be(e) {
  return {
...
function Ue(e, t, a, r) {
  if (e.length < t + 10)
    throw new Error("body too short: " + e.length + ", base=" + t);
  const n = ((255 & e[t + 8]) << 8) | (255 & e[t + 9]);
  if (n <= 0) throw new Error("invalid empty frame length at " + t);
  if (n + t + 10 > e.length)
    throw new Error(
      "invalid frame length " + n + " at " + t + " for " + e.length,
    );
  const i = e.slice(0, t + 8),
    o = e.slice(t + 10, t + 10 + n),
    s = e.slice(t + 10 + n),
    l = Be(r),
    c = Le(o, a, r),
    d = r.locations - l.locations + (r.wifi - l.wifi) + (r.cell - l.cell);
  if (c.length > 65535)
    throw new Error("patched payload too large: " + c.length);
  if (d <= 0 || Ce(o, c))
    throw (
      Fe(r, l),
      new Error("frame parsed but no patchable wloc payload at " + t)
    );
  return Se([i, [(c.length >> 8) & 255, 255 & c.length], c, s]);
}
function readUInt16BE(e, t) {
  if (t + 2 > e.length) throw new Error("uint16 exceeds buffer");
  return 256 * (255 & e[t]) + (255 & e[t + 1]);
}
function readUInt32BE(e, t) {
  if (t + 4 > e.length) throw new Error("uint32 exceeds buffer");
  return (
    16777216 * (255 & e[t]) +
    65536 * (255 & e[t + 1]) +
    256 * (255 & e[t + 2]) +
...
function tryParseArpcEnvelope(e) {
  try {
    let t = 0;
    if (readUInt16BE(e, t) <= 0) return null;
    t += 2;
    for (let a = 0; a < 3; a++) {
      const a = readUInt16BE(e, t);
      if (a > 1024 || t + 2 + a > e.length) return null;
      t += 2 + a;
    }
    ...
    const a = t,
      r = readUInt32BE(e, t);
    t += 4;
    if (r <= 0 || t + r > e.length) return null;
...
function tryPatchArpcEnvelope(e, t, a) {
  const r = tryParseArpcEnvelope(e);
  if (!r) return null;
  const n = Le(r.payload, t, a);
  if (n.length === r.payload.length && Ce(n, r.payload)) return null;
  return Se([
    e.slice(0, r.payloadLengthOffset),
    writeUInt32BE(n.length),
    n,
    r.suffix,
  ]);
}
...
function Ie(e, a) {
  ...
  const s = tryPatchArpcEnvelope(e, a, r);
  if (s)
    return (
      t.info(
        `[wloc] patched ARPC locations=${r.locations} wifi=${r.wifi} cell=${r.cell} skipped=${r.skipped}`,
      ),
      { data: s, stats: r, frameKind: "arpc" }
    );
  const n = [],
    i = [0, 2, 4, 6, 8, 10, 12, 14, 16],
    o = Math.min(96, Math.max(0, e.length - 10));
  for (let e = 0; e <= o; e++) i.indexOf(e) < 0 && i.push(e);
  for (let o = 0; o < i.length; o++) {
    ...
    try {
      ...
      return (
        t.info(
          `[wloc] patched at offset=${s} locations=${r.locations} wifi=${r.wifi} cell=${r.cell} skipped=${r.skipped}`,
        ),
        { data: n, stats: r, frameKind: "framed" }
      );
    } catch (e) {
      (Fe(r, l),
        n.length < 6 &&
          n.push("@" + s + ":" + (e && e.message ? e.message : String(e))));
    }
  }
  try {
    const n = (function (e, t, a) {
      const r = [],
        n = Math.min(256, e.length);
      for (let i = 0; i <= n; i++) {
        const n = Be(a);
        try {
          const r = e.slice(i),
            o = Le(r, t, a);
          if (
            a.locations - n.locations + (a.wifi - n.wifi) + (a.cell - n.cell) >
              0 &&
            !Ce(r, o)
          )
            return Se([e.slice(0, i), o]);
          Fe(a, n);
        } catch (e) {
          (Fe(a, n),
            r.length < 6 &&
              r.push(
                "raw@" + i + ":" + (e && e.message ? e.message : String(e)),
              ));
        }
      }
      throw new Error("raw protobuf scan failed; " + r.join(" | "));
    })(e, a, r);
    return (
      t.info(
        `[wloc] patched via raw fallback locations=${r.locations} wifi=${r.wifi} cell=${r.cell} skipped=${r.skipped}`,
      ),
      { data: n, stats: r, frameKind: "bare" }
    );
  } catch (e) {
    n.push("raw:" + (e && e.message ? e.message : String(e)));
  }
  throw new Error("no patchable wloc payload found; " + n.join(" | "));
}
function Me(e) {
  return e.length >= 2 && 31 === e[0] && 139 === e[1];
}
async function De(e, a, r) {
  const n = e.url || "";
  t.group(`[wloc] Response ${n}`);
  try {
    let e = (function (e) {
      if (!e) return [];
      if ("undefined" != typeof ArrayBuffer) {
        if (e instanceof ArrayBuffer)
          return Array.prototype.slice.call(new Uint8Array(e));
        if (ArrayBuffer.isView && ArrayBuffer.isView(e))
          return Array.prototype.slice.call(
            new Uint8Array(e.buffer, e.byteOffset, e.byteLength),
          );
      }
      if ("number" == typeof e.length && "string" != typeof e) {
        const t = [];
        for (let a = 0; a < e.length; a++) t.push(255 & e[a]);
        return t;
      }
      if ("string" == typeof e) {
        const t = [];
    ...
    return (t.error(`[wloc] ${e.message || e}`), a);
  } finally {
    t.groupEnd();
  }
}
...
function Pe() {
  ...
  return (
    null == r.longitude || null == r.latitude
      ...
      : t.debug(
          `[settings] lon=${r.longitude} lat=${r.latitude} acc=${r.accuracy}`,
        ),
    r
  );
}
